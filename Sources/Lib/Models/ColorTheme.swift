...
enum ColorTheme: String, CaseIterable {
    ...
    func color(for status: AgentStatus) -> Color {
        ...
        case .trafficLight:
            ...
            case .working, .delegating: return Color(red: 0.298, green: 0.553, blue: 1.0)
        ...
        case .oceanDepths:
            ...
            case .working, .delegating: return Color(red: 0.118, green: 0.227, blue: 0.373)
        ...
        case .sunsetBoulevard:
            ...
            case .working, .delegating: return Color(red: 0.925, green: 0.286, blue: 0.600)
        ...
        case .neonNights:
            ...
            case .working, .delegating: return Color(red: 0.231, green: 0.510, blue: 0.965)
        ...
        case .forestFloor:
            ...
            case .working, .delegating: return Color(red: 0.302, green: 0.486, blue: 0.059)
        ...
        case .candyApple:
            ...
            case .working, .delegating: return Color(red: 0.220, green: 0.741, blue: 0.973)
        ...
        case .firecracker:
            ...
            case .working, .delegating: return Color(red: 0.145, green: 0.388, blue: 0.922)
